...
export default function Hero() {
  return (
    <section id="topo" className="relative overflow-hidden bg-white dark:bg-neutral-950">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(200,169,106,0.18),transparent_55%)]" />
      ...
      <Container className="relative grid items-center gap-10 py-14 md:grid-cols-2 md:py-20">
        <div>
          <p className="mb-3 inline-flex rounded-full border border-neutral-200 bg-white/70 px-3 py-1 text-xs tracking-wide text-neutral-600 backdrop-blur">
            Atendimento premium • Agenda pelo WhatsApp
          </p>

          <h1 className="text-4xl font-semibold tracking-tight text-neutral-950 md:text-5xl">
            Atendimento com excelência e cuidado de verdade.
          </h1>

          <p className="mt-4 max-w-xl text-base leading-relaxed text-neutral-600 md:text-lg">
            Página profissional elegante para apresentar serviços, gerar confiança
            e facilitar o agendamento com um clique.
          </p>
  ...
  target="_blank"
  rel="noreferrer"
  className="group inline-flex items-center gap-2 rounded-xl bg-[linear-gradient(135deg,#C8A96A,rgba(200,169,106,0.75))] px-6 py-3 text-sm font-semibold text-neutral-950 shadow-sm ring-1 ring-black/10 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md"
>
  {/* Ícone WhatsApp */}
  <svg
  ...
  Agendar pelo WhatsApp
          ...
          <div className="mt-8 grid max-w-lg grid-cols-3 gap-3 text-xs text-neutral-600">
            <div className="rounded-xl border border-neutral-200 bg-white p-3">
              <p className="font-medium text-neutral-900">Rápido</p>
              <p className="mt-1">Carrega leve no celular</p>
            </div>
            <div className="rounded-xl border border-neutral-200 bg-white p-3">
              <p className="font-medium text-neutral-900">Confiável</p>
              <p className="mt-1">Visual de alto padrão</p>
            </div>
            <div className="rounded-xl border border-neutral-200 bg-white p-3">
              <p className="font-medium text-neutral-900">Direto</p>
              <p className="mt-1">CTA forte para WhatsApp</p>
            </div>
          </div>
        </div>
